...
void init_scr_del_flag(lv_ui *ui)
{
    ...
    ui->Home_del = true;
    ui->Menu_del = true;
    ui->Calender_del = true;
    ui->Calculater_del = true;
    ui->Stopwatch_del = true;
    ui->Heart_del = true;
    ui->Environment_del = true;
    ui->Compass_del = true;
    ui->Game_del = true;
    ui->Setting_del = true;
    ui->SetLightTime_del = true;
    ui->SetOffTime_del = true;
    ui->SetDateTime_del = true;
    ui->SetDate_del = true;
    ui->SetTime_del = true;
    ui->PowerOff_del = true;
}
